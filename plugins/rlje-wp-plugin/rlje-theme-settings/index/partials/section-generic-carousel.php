...
<div class="view-all hidden-xs">
	<a href="<?php echo esc_url( trailingslashit( home_url( '/browse/' . $section_key ) ) ); ?>"> View all <span><img width="8" src="https://api.rlje.net/acorn/artwork/size/double-arrows-white?t=Icons"/></span></a>
</div>
<?php endif; ?>
	...
	<div class="carousel carousel-respond-slide slide" id="<?php echo esc_attr( $section_key ); ?>" data-interval="false">
		...
		<a class="left carousel-control" href="#<?php echo esc_attr( $section_key ); ?>" id="carousel-arrow" data-slide="prev"><img class="carousel-img" src="https://api.rlje.net/acorn/artwork/size/carousel-left?t=Icons"/></a>
		<a class="right carousel-control" href="#<?php echo esc_attr( $section_key ); ?>" id="carousel-arrow" data-slide="next"><img class="carousel-img" src="https://api.rlje.net/acorn/artwork/size/carousel-right?t=Icons"/></a>
		<?php endif; ?>
	</div>
<?php
endif;
