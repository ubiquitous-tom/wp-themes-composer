...
<?php endif; ?>
	<div class="col-sm-6 col-md-6 col-lg-3" itemscope itemtype="http://schema.org/TVSeries" data-az="<?php echo $data_a_z; ?>" data-added="<?php echo $key + 1; ?>">
		<a itemprop="url" href="<?php echo $base_url_path . '/' . $item->id; ?>/">
			...
			<img title="<?php echo $item->name; ?>" alt="<?php echo $item->id; ?>" class="wp-post-image" itemprop="image" src="<?php echo rljeApiWP_getImageUrlFromServices( $item_image . '?t=titled-avatars&w=550' ); ?>" style="width:100%; height:auto;" />
		</a>
