...
abstract class GFPaymentAddOn extends GFFeedAddOn {
	...
	public function requires_credit_card_message() {
		return sprintf( __( "You must add a Credit Card field to your form before creating a feed. Let's go %sadd one%s!", 'gravityforms' ), "<a href='" . esc_url( add_query_arg( array( 'view' => null, 'subview' => null ) ) ) . "'>", '</a>' );
	}
