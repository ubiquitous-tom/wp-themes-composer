	...
	<div class="container browse">
		<div id="contentPane" class="span9">
			<div id="contactus-view" class="url-view">
				<script defer src="<?php echo get_template_directory_uri(); ?>/lib/jquery/jquery.validate.min.js"></script>
				<script defer src="<?php echo get_template_directory_uri(); ?>/js/contactForm.js"></script>
				<div class="row-fluid">
					<div class="span10">
						...
						<div id="diagnostic">
							...
							<form method="post" id="acornDiagnostic" name="acornDiagnostic" accept-charset="UTF-8" novalidate="novalidate">
								...
								<p style="margin-bottom:20px;">
									Please be sure to visit the <a href="<?php echo home_url( 'support/home' ); ?>" target="_blank"><?php bloginfo( 'name' ); ?> Help Center</a>
									for answers to frequently asked questions, up-to-the-minute alerts, and solutions to many common issues.
									If you need additional assistance, please <?php if ( ! rljeApiWP_getCountryCode() ) : ?>select a category and <?php endif; ?>provide a description of the issue you are experiencing.
								</p>
								...
								<div class="control-group" style="margin-top:25px;">
									...
									<div class="controls">
										<input type="text" id="email" name="email" class="input-block-level required email valid" value="<?php echo $emailAddress; ?>">
									</div>
								</div>
