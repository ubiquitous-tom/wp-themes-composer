...
<head>
    ...
    $isCustomMetaTitleAndDesc = false;
...
<body>
    ...
    <?php if(defined('SAILTHRU_CUSTOMER_ID') && !empty(SAILTHRU_CUSTOMER_ID)): ?>
      ...
      <div class="container">
        ...
        <ul class="navbar-right-ul accountUser">
            <li class="navbar-right">
                ...
                <ul class="drop-select closed">
                    ...
                    <a href="https://account<?= $environment; ?>.acorn.tv/#accountStatus"><li>Manage Account</li></a>
                    <a href="https://account<?= $environment; ?>.acorn.tv/#editPassword"><li>Change Password</li></a>
                    <?php if($webPaymentEdit): ?>
                    <a href="https://account<?= $environment; ?>.acorn.tv/#editBilling"><li>Update Billing Info</li></a>
                    <a href="https://account<?= $environment; ?>.acorn.tv/#editEmail"><li>Change Email</li></a>
                    <?php endif; ?>
                    <a href="https://account<?= $environment; ?>.acorn.tv/#logout"><li>Log Out</li></a>
                </ul>
            </li>
        </ul>
        <?php else : ?>
        <ul class="navbar-right-ul">
            <li class="navbar-right hidden-md hidden-lg" ><a class="log-in" href="https://signup<?= $environment; ?>.acorn.tv/">SIGN UP</a></li>
            <li class="navbar-right visible-md visible-lg"> <a  class="free-month" href="https://signup<?= $environment; ?>.acorn.tv/">START FREE TRIAL</a></li>
            <li class="navbar-right"><a class="log-in" href="https://signup<?= $environment; ?>.acorn.tv/signin.html">LOG IN</a></li>
        </ul>
        <?php endif; ?>
        ...
        <div class="navbar-collapse side-collapse in">
          <ul class="nav navbar-nav">
            <form id="searchform" action="/" method="get" onsubmit="return search(this)">
                ...
                <input type="text" size="18" name="s" id="search-input" value="<?= (!empty($wp_query->query_vars['search_text'])) ? urldecode($wp_query->query_vars['search_text']): '';?>">
            </form>
            <li><a href="/">Home</a></li>
            <li><a href="/browse">Browse</a></li>
            <li><a href="/schedule">Schedule</a></li>
            <li><a href="http://support.acorn.tv">Help</a></li>
            <li><a id="store-link" href="https://store<?= $environment; ?>.acorn.tv"  style="color:#fff;" >Store</a> </li>
          </ul>
        </div><!--/.nav-collapse -->
        <div class="active-features">
            <?php 
                ...
                if($futureDate):
            ?>
            <div class="navbar-future-date"><span>Future Date: <?= $futureDate; ?></span></div>
            <?php 
                endif;
