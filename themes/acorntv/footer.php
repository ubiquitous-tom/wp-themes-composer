...
<div class="sub-footer">
    <div class="container" style="margin-bottom: 45px; margin-top: 45px;">
        ...
        <div class="col-xs-6 col-sm-6 col-md-3 col-lg-2">
            <ul>
                <h5>Shop</h5>
                <li><a href="https://signup<?= $environment; ?>.acorn.tv/createaccount.html">Free Trial Signup</a></li>
                <li><a href="https://store<?= $environment; ?>.acorn.tv/#home">Subscription Options</a></li>
                <li><a href="https://store<?= $environment; ?>.acorn.tv/#give">Buy A Gift</a></li>
                <li><a href="https://signup<?= $environment; ?>.acorn.tv/createaccount-p.html">Redeem A Gift</a></li>
            </ul>
        </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-2">
            <ul>
                ...
                <li><a class="AcornAppLink" data-qs="/help/contactus" href="<?= $baseUrlPath; ?>/contactus">Contact Us</a></li>
           </ul>
        </div>
    </div>
</div>
...
<div class="container footer">
    ...
    <div class="col-md-6 column hidden-xs hidden-sm">  
        <ul>
            <li><a class="open-dialog fancybox.iframe" href="https://api.rlje.net/acorntv-help/acorntv-privacy-policy.html">Privacy Policy</a></li>
            <li><a class="open-dialog fancybox.iframe" href="https://api.rlje.net/acorntv-help/closed-captioning-policy.html">Captioning Policy</a></li>
        </ul>
    </div>
</div>
...
?>
<?php 
    $stripeCustomerID = (!empty($_COOKIE['ATVSessionCookie'])) ? rljeApiWP_getStripeCustomerId($_COOKIE['ATVSessionCookie']) : false;
    if($stripeCustomerID) : 
?>
<style>
...
<script type="text/javascript">
  (function(d, t) {
    ...
    e.setAttribute('data-stripe-id', '<?php echo $stripeCustomerID; ?>');
